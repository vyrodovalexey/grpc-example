...
const (
	TestService_Unary_FullMethodName               = "/api.v1.TestService/Unary"
	TestService_ServerStream_FullMethodName        = "/api.v1.TestService/ServerStream"
	TestService_BidirectionalStream_FullMethodName = "/api.v1.TestService/BidirectionalStream"
)
...
func (c *testServiceClient) ServerStream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *testServiceClient) BidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[BidirectionalRequest, BidirectionalResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[1], TestService_BidirectionalStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedTestServiceServer) ServerStream(*StreamRequest, grpc.ServerStreamingServer[StreamResponse]) error {
...
func _TestService_ServerStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TestServiceServer).ServerStream(m, &grpc.GenericServerStream[StreamRequest, StreamResponse]{ServerStream: stream})
}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/v1/test.proto",
}
