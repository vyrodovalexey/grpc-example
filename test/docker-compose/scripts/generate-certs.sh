...
CERTS_DIR="${1:-./certs}"
CA_SUBJECT="/C=US/ST=Test/L=Test/O=gRPC-Test/OU=Dev/CN=Test Root CA"
SERVER_CN="grpc-server"
CLIENT_CN="grpc-client"
DAYS=365
KEY_SIZE=2048
...
generate_server_cert() {
  ...
  openssl req -new \
    ...
    -subj "/C=US/ST=Test/L=Test/O=gRPC-Test/OU=Server/CN=${SERVER_CN}" \
    2>/dev/null
...
generate_client_cert() {
  ...
  openssl req -new \
    ...
    -subj "/C=US/ST=Test/L=Test/O=gRPC-Test/OU=Client/CN=${cn}" \
    2>/dev/null
